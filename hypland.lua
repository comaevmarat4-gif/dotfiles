...
hl.config({
    ...
    col = {
                -- Красивый градиент: от нежно-голубого к мягкому фиолетовому
                active_border   = { colors = {"rgba(7aa2f7ee)", "rgba(bb9af7ee)"}, angle = 45 },
                -- Спокойный темно-серый цвет для неактивного окна
...
hl.config({
    input = {
        ...
        sensitivity = 0, -- -1.0 - 1.1, 0 means no modification.
...
-- Switch workspaces with mainMod + inin[0-9]
...
hl.on("hyprland.start", function ()
    ...
    -- Можно запускать несколько приложений одной строкой
    -- hl.exec_cmd("waybar & hyprpaper & nm-applet")
end)